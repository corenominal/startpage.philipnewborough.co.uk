...
<html lang="en-GB" data-bs-theme="dark">
    ...
    <body class="d-flex flex-column vh-100">
                ...
                <div class="offcanvas-body p-0 d-flex flex-column">
                    <nav class="flex-grow-1 py-3" aria-label="Sidebar navigation">
                        ...
                        <ul class="nav flex-column mb-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-white-50 px-3 py-2" href="/admin/shortcuts">
                                    <i class="bi bi-grid-3x3-gap-fill"></i> Shortcuts
                                </a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="toast-container position-fixed bottom-0 end-0 p-3">
            <div id="command-toast" class="toast align-items-center text-bg-secondary border-0" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="d-flex">
